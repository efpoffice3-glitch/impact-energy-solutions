        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <button
              ...
              className="ml-4 flex items-center gap-2 bg-[#25D366] hover:bg-[#20BA59] text-white px-4 py-2 rounded-lg transition-all hover:scale-105 shadow-md"
            >
          ...
          <div className="lg:hidden mt-4 space-y-2 pb-4">
            ...
            <div>
              <button
                ...
                className="w-full text-left text-sm font-medium text-muted-foreground hover:text-primary transition-colors px-3 py-2 rounded-md hover:bg-accent/50 flex items-center justify-between"
              >
                Serviços
            ...
            <button
              onClick={handleWhatsApp}
              className="w-full flex items-center gap-2 bg-[#25D366] hover:bg-[#20BA59] text-white px-4 py-3 rounded-lg transition-all mt-4"
            >
              <Phone className="h-4 w-4" />
              <span className="font-medium">WhatsApp</span>
            </button>
